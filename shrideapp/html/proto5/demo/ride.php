...
<body>
  ...
  <div data-role="page" id="rpnew2" data-theme="d">
    ...
    <div data-role="footer">
      <a data-icon="carat-l" data-rel="back" back-btn="true">Back</a>
      <a href="#rpnew3" data-icon="carat-r" data-role="button" data-rel="next" class="next" data-mini="true">Next</a>
    </div>
    </br>
  </div>
  ...
  <div data-role="page" id="rpnew3" data-theme="d">
    ...
    <div data-role="footer">
      <a data-icon="carat-l" data-rel="back" back-btn="true">Back</a>
      <a href="#rpnew4" data-icon="carat-r" data-role="button" data-rel="next" class="next" data-mini="true">Next</a>
    </div>
    </br>
  </div>
  ...
  <div data-role="page" id="rpnew4" data-theme="d">
    ...
    <div data-role="footer">
      <a data-icon="carat-l" data-rel="back" back-btn="true">Back</a>
      <a href="#rpnew5" data-icon="carat-r" data-role="button" data-rel="next" class="next" data-mini="true">Next</a>
    </div>
    </br>
  </div>
