...
<head>
  ...
  function newDrive(){
    ...
    alert(datetime+addressfrom+addressto+seats+charge+notif);
  }
...
<body>
  ...
  <div data-role="page" id="createnewdrive" data-theme="d">
    ...
    <div data-role="footer">
      ...
      <a href="#dpnew2" data-role="button" data-icon="carat-r" data-mini="true">Next</a>
    </div>
    </br>
  </div>
  ...
  <div data-role="page" id="dpnew2" data-theme="d">
    ...
    <div data-role="footer">
      <a data-icon="carat-l" data-rel="back" back-btn="true">Back</a>
      <a href="#dpnew3" data-icon="carat-r" data-role="button" data-rel="next" class="next" data-mini="true">Next</a>
    </div>
    </br>
  </div>
  ...
  <div data-role="page" id="dpnew3" data-theme="d">
    ...
    <div data-role="footer">
      <a data-icon="carat-l" data-rel="back" back-btn="true">Back</a>
      <a href="#dpnew4" data-icon="carat-r" data-role="button" data-rel="next" class="next" data-mini="true">Next</a>
    </div>
    </br>
  </div>
  ...
  <div data-role="page" id="dpnew4" data-theme="d">
    ...
    <div data-role="footer">
      <a data-icon="carat-l" data-rel="back" back-btn="true">Back</a>
      <a href="#dpnew5" data-icon="carat-r" data-role="button" data-rel="next" class="next" data-mini="true">Next</a>
    </div>
    </br>
  </div>
